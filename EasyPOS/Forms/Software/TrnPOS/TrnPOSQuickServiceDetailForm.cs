...
{
    public partial class TrnPOSQuickServiceDetailForm : Form
    {
        ...
        public TrnPOSQuickServiceDetailForm(SysSoftwareForm softwareForm, TrnPOSTouchQuickServiceForm POSTouchQuickServiceForm, Entities.TrnSalesEntity salesEntity)
        {
            InitializeComponent();
            ...
            try
            {
                if (Modules.SysCurrentModule.GetCurrentSettings().HideSalesItemDetail == false)
                {
                    ...
                    if (detailItem != null)
                    {
                        ...
                        TrnPOSSalesItemDetailForm trnSalesDetailSalesItemDetailForm = new TrnPOSSalesItemDetailForm(null, null, this, trnSalesLineEntity, null);
        ...
        {
            TrnPOSSearchItemForm trnSalesDetailSearchItemForm = new TrnPOSSearchItemForm(null, null, this, trnSalesEntity);
        ...
        private void buttonTender_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToDecimal(textBoxTotalSalesAmount.Text) > 0)
            {
                if (Modules.SysCurrentModule.GetCurrentSettings().ShowServiceCharge == true)
                {
                    ...
                    {
                        Decimal ServiceCharge = Convert.ToDecimal(textBoxTotalSalesAmount.Text) * 0.10m;
                        Controllers.TrnSalesController trnSalesController = new Controllers.TrnSalesController();
                        ...
                        Entities.TrnSalesEntity newSalesEntity = new Entities.TrnSalesEntity
                        {
                            ...
                            Amount = Convert.ToDecimal(textBoxTotalSalesAmount.Text) + ServiceCharge,
                        ...
                        {
                            TrnPOSTenderForm trnSalesDetailTenderForm = new TrnPOSTenderForm(sysSoftwareForm, null, null, null, null, trnPOSTouchQuickServiceForm, this, newSalesEntity);
        ...
        private void buttonDiscount_Click(object sender, EventArgs e)
        {
            ...
            if (listSalesLine.Any())
            {
                ...
                TrnPOSDiscountForm trnSalesDetailDiscountForm = new TrnPOSDiscountForm(null, null, this, salesAmount, groupedSalesLine.ToList());
                trnSalesDetailDiscountForm.ShowDialog();
            }
            else
            {
                TrnPOSDiscountForm trnSalesDetailDiscountForm = new TrnPOSDiscountForm(null, null, this, salesAmount, new List<Entities.TrnSalesLineEntity>());
                trnSalesDetailDiscountForm.ShowDialog();
            }
        }
        ...
        public void GetSalesLineList()
        {
            ...
            if (salesLineList.Any())
            {
                ...
                if (trnSalesEntity.ServiceChargeAmount > 0)
                {
                    textBoxTotalSalesAmount.Text = (totalSalesAmount + trnSalesEntity.ServiceChargeAmount).ToString("#,##0.00");
        ...
        {
            TrnPOSLockSalesForm trnPOSLockSalesForm = new TrnPOSLockSalesForm(null, null, this, trnSalesEntity);
        ...
        {
            TrnPOSDownloadItemsForm TrnPOSDownloadItemsForm = new TrnPOSDownloadItemsForm(sysSoftwareForm, null, null, this, trnSalesEntity.Id);
            TrnPOSDownloadItemsForm.ShowDialog();
        }

        private void buttonReturn_Click(object sender, EventArgs e)
        {
            TrnPOSReturn trnPOSReturn = new TrnPOSReturn(null, null, this);
        ...
        {
            Account.SysLogin.SysLoginForm login = new Account.SysLogin.SysLoginForm(null, null, null, null, null, this, true);
            login.ShowDialog();
        }
        ...
        {
            SysKeyboard.SysKeyboardForm sysKeyboardForm = new SysKeyboard.SysKeyboardForm(null, null, null, null, null, null, null, null, this, "Barcode");
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            if (trnPOSTouchQuickServiceForm != null)
            {
                if (blinkOn)
                {
                    labelFlashNotes.Text = Modules.SysCurrentModule.GetCurrentSettings().FlashNotes;
                    labelFlashNotes.Visible = true;
                }
                else
                {
                    labelFlashNotes.Visible = false;
                }
                blinkOn = !blinkOn;
            }
        }
