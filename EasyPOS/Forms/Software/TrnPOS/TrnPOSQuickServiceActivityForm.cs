...
{
    public partial class TrnPOSQuickServiceActivityForm : Form
    {
        public SysSoftwareForm sysSoftwareForm;

        public TrnPOSTouchQuickServiceForm trnPOSTouchQuickServiceForm;
        public Entities.TrnSalesEntity trnSalesEntity;
        public TrnPOSQuickServiceActivityForm(SysSoftwareForm softwareForm, TrnPOSTouchQuickServiceForm POSTouchQuickServiceForm, Entities.TrnSalesEntity salesEntity)
        {
            InitializeComponent();
        ...
        {
            sysSoftwareForm.AddTabPagePOSQuickServiceSalesDetail(trnPOSTouchQuickServiceForm, trnSalesEntity);
            Close();
        }
        ...
        private void buttonTender_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    TrnPOSTenderForm trnSalesDetailTenderForm = new TrnPOSTenderForm(sysSoftwareForm, null, null, null, null, trnPOSTouchQuickServiceForm, null, newSalesEntity);
        ...
        private void buttonCancel_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (isTendered == true)
                {
                    TrnPOSCancelRemarksForm trnSalesListCancelRemarksForm = new TrnPOSCancelRemarksForm(sysSoftwareForm, null, null, trnPOSTouchQuickServiceForm, trnSalesEntity.Id);
        ...
        private void buttonDeliver_Click(object sender, EventArgs e)
        {
            ...
            {
                TrnPOSQuickServicieActivityDeliverForm trnPOSQuickServicieActivityDeliverForm = new TrnPOSQuickServicieActivityDeliverForm(trnPOSTouchQuickServiceForm, this, trnSalesEntity.Id, trnSalesEntity.Remarks);
                trnPOSQuickServicieActivityDeliverForm.ShowDialog();
            }
            else
            {
